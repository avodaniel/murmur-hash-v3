...
public class EmbeddedLibraryTools {
    public static final boolean LOADED_MURMUR;

    static {
        LOADED_MURMUR = loadEmbeddedLibrary("libmurmur-hash-v3-java");
    }
    ...
    private static boolean loadEmbeddedLibrary(final String name) {
        ...
        for (String ext : allowedExtensions) {
            ...
            nativeLibraryUrl = MurmurHashV3.class.getResource(url.toString() + ext);
